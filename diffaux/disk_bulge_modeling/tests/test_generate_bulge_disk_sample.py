...
from ..generate_bulge_disk_sample import get_bulge_disk_test_sample, get_bulge_disk_decomposition
...
def test_get_bulge_disk_decomposition():
    ...
    redshift = 0.05
    Lbox = 50.0
    diffstar_cens = get_bulge_disk_test_sample(ran_key, lgmp_min=lgmp_min,
                                               redshift=redshift, Lbox=Lbox)
