...
def test_disk_knot_kern():
    ...
    for __ in range(n_tests):
        ...
        age_weights_burst = _pureburst_age_weights_from_params(ssp_lg_age_yr, lgyr_peak, lgyr_max)
...
def test_disk_knot_vmap():
    ...
    lgyr_peak = DEFAULT_BURST_PARAMS.lgyr_peak
    lgyr_max = DEFAULT_BURST_PARAMS.lgyr_max
    age_weights_singleburst = _pureburst_age_weights_from_params(ssp_lg_age_yr, lgyr_peak, lgyr_max)
